            ...
            <div class="container mt" style="margin-top: 100px;">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <div class="card-gift-desc-gifts border border-1 rounded p-2">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-between">
                                ...
                                @else
                                    <button type="button" style="all: unset; cursor: pointer;" data-bs-toggle="modal"
                                        data-bs-target="#loginModal" onclick="setRedirectUrl()" class="position-relative">
                                        <i class="bi bi-plus-lg ms-auto gift-cart"></i>
                                    </button>
                                @endif
                            </div>
                            ...
                            <div class="sold-by-gift my-2 px-2 flex-wrap h-auto py-1"> Published by:
                                <a href="{{ route('gift.seller', ['id' => $giftNcoupon->adminId]) }}"
                    ...
                    <div class="col-md-9 ps-md-4 mt-3 mt-md-0 border-0 fixed-height-gifts">
                        <h2 class="fw-semibold">{{ ucfirst($giftNcoupon->title) }}</h2>
                                            ...
                                            @foreach ($giftComments as $cmt)
                                                ...
                                                <div
                                                    ...
                                                    <img alt="Profile picture of Carrie Bradshaw"
                                                        ...
                                                        src="{{ $cmt->jobSeeker->userThumbnail ? $cmt->jobSeeker->userThumbnail : asset('frontend/assets/Images/profile.jpg') }}" />
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <div class="mx-auto rounded-circle bg-danger bg-opacity-10 d-flex align-items-center justify-content-center"
                                                                            ...
                                                                            <i
                                                                                class="bi bi-trash-fill text-danger fs-3"></i>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex justify-content-center align-items-center"
                                                                        ...
                                                                        <form class="w-100"
                                                                            action="{{ route('giftcomment.delete', ['id' => $cmt->id]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                            ...
                            @if (Auth::guard('job_seekers')->check())
                                <form action="{{ route('giftcomment.add') }}" method="post">
                                    ...
                                    <div
                                        ...
                                        <img alt="Profile picture of user"
                                            class="rounded-circle gifts-chat me-2 img-thumbnail"
                                        ...
                                        <button type="submit" class="btn w-10 ms-2 comment-button" id="sendButton"
                                            style="background-color: #0064a7; color: #fff;">
