    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModallLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-4 rounded-4 border-0 shadow-lg text-center">
                ...
                <form method="POST" id="deleteForm" class="d-flex justify-content-center align-items-center" style="box-sizing: border-box;">
                    @csrf
                    @method('DELETE')
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex gap-2">
                                    <input type="text" name="day" id="editDay" class="form-control"
                                        placeholder="Day" required maxlength="2" style="max-width: 70px;">
                                    <input type="text" name="month" id="editMonth" class="form-control"
                                        placeholder="Month" required maxlength="10" style="max-width: 120px;">
                                    <input type="text" name="year" id="editYear" class="form-control"
                                        placeholder="Year" required maxlength="4" style="max-width: 90px;">
                                </div>
                            </div>

                            <div class="col-md-4 mt-3">
                                <label>Place of Birth</label>
                                <input type="text" name="personPlaceOfBirth" id="editPlace" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <div class="d-flex gap-2">
                                    <input type="text" name="hour" id="editHour" class="form-control"
                                        placeholder="Hour" required maxlength="2" style="max-width: 70px;">
                                    <input type="text" name="minute" id="editMinute" class="form-control"
                                        placeholder="Minute" required maxlength="2" style="max-width: 70px;">
                                    <input type="text" name="second" id="editSecond" class="form-control"
                                        placeholder="Second" maxlength="2" style="max-width: 70px;">
                                </div>
                            </div>
