            ...
            <table class="table mb-0 text-nowrap align-middle">
                ...
                <tbody>
                    ...
                    <tr class="border-bottom border-secondary-subtle py-1">
                        ...
                        <td>
                            <small style="font-size: 14px; background-color: {{ 
                                    $form->status == 'approved' ? '#085927' : 
                                    ($form->status == 'rejected' ? '#EE2F2F' : 
                                    ($form->status == 'In-progress' ? '#1A73E8' : '#FEC53D')) 
                                }}; color: white; padding: 2px 8px; border-radius: 4px;">
                                {{ ucfirst(str_replace('-', ' ', $form->status)) }}
                            </small>
                        </td>
                        <td>
                            ...
                            <a href="{{ route('form.complete', $form->id) }}"
                                ...
                                Fill More
                                <i class="bi bi-arrow-right ps-2" style="font-weight: 700;"></i>
                            </a>
                            @else
