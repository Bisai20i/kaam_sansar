        ...
        <form method="POST" id="deleteForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Delete Kundali Matching</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">Are you sure you want to delete this kundali matching?</div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-2">
                                    <div style="max-width: 70px;">
                                        <input type="number" name="girlDOBDay" id="editGirlDOBDay" class="form-control" min="1" max="31" required placeholder="Day">
                                    </div>
                                    <div style="max-width: 120px;">
                                        <select name="girlDOBMonth" id="editGirlDOBMonth" class="form-select" required>
                                    ...
                                    <div style="max-width: 90px;">
                                        <input type="number" name="girlDOBYear" id="editGirlDOBYear" class="form-control" min="1900" max="2100" required placeholder="Year">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-2">
                                    <div style="max-width: 70px;">
                                        <input type="number" name="girlTimeHour" id="editGirlTimeHour" class="form-control" min="0" max="23" required placeholder="Hour">
                                    </div>
                                    <div style="max-width: 70px;">
                                        <input type="number" name="girlTimeMinute" id="editGirlTimeMinute" class="form-control" min="0" max="59" required placeholder="Minute">
                                    </div>
                                    <div style="max-width: 70px;">
                                        <input type="number" name="girlTimeSecond" id="editGirlTimeSecond" class="form-control" min="0" max="59" placeholder="Second">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="girlPlaceOfBirth" id="editGirlPlace" class="form-control" required>
                        </div>
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-2">
                                    <div style="max-width: 70px;">
                                        <input type="number" name="boyDOBDay" id="editBoyDOBDay" class="form-control" min="1" max="31" required placeholder="Day">
                                    </div>
                                    <div style="max-width: 120px;">
                                    ...
                                    <div style="max-width: 90px;">
                                        <input type="number" name="boyDOBYear" id="editBoyDOBYear" class="form-control" min="1900" max="2100" required placeholder="Year">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-2">
                                    <div style="max-width: 70px;">
                                        <input type="number" name="boyTimeHour" id="editBoyTimeHour" class="form-control" min="0" max="23" required placeholder="Hour">
                                    </div>
                                    <div style="max-width: 70px;">
                                        <input type="number" name="boyTimeMinute" id="editBoyTimeMinute" class="form-control" min="0" max="59" required placeholder="Minute">
                                    </div>
                                    <div style="max-width: 70px;">
                                        <input type="number" name="boyTimeSecond" id="editBoyTimeSecond" class="form-control" min="0" max="59" placeholder="Second">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label> Place of Birth</label>
                            <input type="text" name="boyPlaceOfBirth" id="editBoyPlace" class="form-control" required>
                        </div>
