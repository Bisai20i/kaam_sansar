                ...
                <div class="mt-4">
                    ...
                    <form id="bankAccount" action="{{ isset($bankAccount) ? route('bankAccounts.update', $bankAccount->id) : route('bankAccounts.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-da fs-6" id="preferredBank" name="preferredBank" value="{{ old('preferredBank', $bankAccount->preferredBank ?? '') }}" required maxlength="255" placeholder="Enter preferred bank">
                                    </div>
                                    <div class="col">
                                        <label for="branch" class="form-label fs-6">Branch <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="branch" name="branch" value="{{ old('branch', $bankAccount->branch ?? '') }}" required maxlength="255" placeholder="Enter branch">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-da fs-6" id="firstName" name="firstName" value="{{ old('firstName', $bankAccount->firstName ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="middleName" class="form-label fs-6">Middle Name:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="middleName" name="middleName" value="{{ old('middleName', $bankAccount->middleName ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="lastName" class="form-label fs-6">Last Name <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="lastName" name="lastName" value="{{ old('lastName', $bankAccount->lastName ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="mobileNumber" class="form-label fs-6">Mobile Number <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="mobileNumber" name="mobileNumber" value="{{ old('mobileNumber', $bankAccount->mobileNumber ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="phoneNumber" class="form-label fs-6">Phone Number:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="phoneNumber" name="phoneNumber" value="{{ old('phoneNumber', $bankAccount->phoneNumber ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="email" class="form-label fs-6">Email Address:</label>
                                        <input type="email" class="form-control form-control-da fs-6" id="email" name="email" value="{{ old('email', $bankAccount->email ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="nepaliDob" class="form-label fs-6">Date of Birth (BS) <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="date" class="form-control form-control-da fs-6" id="nepaliDob" name="nepaliDob" value="{{ old('nepaliDob', $bankAccount->nepaliDob ?? '') }}" required>
                                    </div>
                                    <div class="col">
                                        <label for="englishDob" class="form-label fs-6">Date of Birth (AD):</label>
                                        <input type="date" class="form-control form-control-da fs-6" id="englishDob" name="englishDob" value="{{ old('englishDob', $bankAccount->englishDob ?? '') }}">
                                    </div>
                                    <div class="col">
                                        <label for="applyFromCountry" class="form-label fs-6">Apply From Country:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="applyFromCountry" name="applyFromCountry" value="{{ old('applyFromCountry', $bankAccount->applyFromCountry ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-da fs-6" id="otherContactDetail" name="otherContactDetail" value="{{ old('otherContactDetail', $bankAccount->otherContactDetail ?? '') }}" maxlength="255">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-da fs-6" id="fatherName" name="fatherName" value="{{ old('fatherName', $bankAccount->fatherName ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="motherName" class="form-label fs-6">Mother's Name <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="motherName" name="motherName" value="{{ old('motherName', $bankAccount->motherName ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="grandfatherName" class="form-label fs-6">Grandfather's Name <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="grandfatherName" name="grandfatherName" value="{{ old('grandfatherName', $bankAccount->grandfatherName ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="spouse" class="form-label fs-6">Spouse Name:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="spouse" name="spouse" value="{{ old('spouse', $bankAccount->spouse ?? '') }}" maxlength="255">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentCountry" name="permanentCountry" value="{{ old('permanentCountry', $bankAccount->permanentCountry ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentProvince" class="form-label fs-6">Province <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentProvince" name="permanentProvince" value="{{ old('permanentProvince', $bankAccount->permanentProvince ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentDistrict" class="form-label fs-6">District <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentDistrict" name="permanentDistrict" value="{{ old('permanentDistrict', $bankAccount->permanentDistrict ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentMunicipality" class="form-label fs-6">Municipality <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentMunicipality" name="permanentMunicipality" value="{{ old('permanentMunicipality', $bankAccount->permanentMunicipality ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentCity" class="form-label fs-6">City <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentCity" name="permanentCity" value="{{ old('permanentCity', $bankAccount->permanentCity ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentWardNo" class="form-label fs-6">Ward No <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentWardNo" name="permanentWardNo" value="{{ old('permanentWardNo', $bankAccount->permanentWardNo ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentStreet" class="form-label fs-6">Street:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentStreet" name="permanentStreet" value="{{ old('permanentStreet', $bankAccount->permanentStreet ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentState" class="form-label fs-6">State:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentState" name="permanentState" value="{{ old('permanentState', $bankAccount->permanentState ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentTole" class="form-label fs-6">Tole <span class="text-danger fw-bold">*</span>:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentTole" name="permanentTole" value="{{ old('permanentTole', $bankAccount->permanentTole ?? '') }}" required maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="permanentHouseNo" class="form-label fs-6">House No:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="permanentHouseNo" name="permanentHouseNo" value="{{ old('permanentHouseNo', $bankAccount->permanentHouseNo ?? '') }}" maxlength="255">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="attestation">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="form-check mt-4">
                                    <input class="form-check-input fs-6" type="checkbox" value="1" id="sameAsPermanent" name="sameAsPermanent" {{ old('sameAsPermanent', $bankAccount->sameAsPermanent ?? 0) == 1 ? 'checked' : '' }}>
                            ...
                            <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryCountry" name="temporaryCountry" value="{{ old('temporaryCountry', $bankAccount->temporaryCountry ?? '') }}" required maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryProvince" class="form-label fs-6">Province <span class="text-danger fw-bold">*</span>:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryProvince" name="temporaryProvince" value="{{ old('temporaryProvince', $bankAccount->temporaryProvince ?? '') }}" required maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryDistrict" class="form-label fs-6">District <span class="text-danger fw-bold">*</span>:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryDistrict" name="temporaryDistrict" value="{{ old('temporaryDistrict', $bankAccount->temporaryDistrict ?? '') }}" required maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryMunicipality" class="form-label fs-6">Municipality <span class="text-danger fw-bold">*</span>:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryMunicipality" name="temporaryMunicipality" value="{{ old('temporaryMunicipality', $bankAccount->temporaryMunicipality ?? '') }}" required maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryWardNo" class="form-label fs-6">Ward No <span class="text-danger fw-bold">*</span>:</label>
                                    <input type="number" class="form-control form-control-da fs-6" id="temporaryWardNo" name="temporaryWardNo" value="{{ old('temporaryWardNo', $bankAccount->temporaryWardNo ?? '') }}" required>
                                </div>
                                <div class="col">
                                    <label for="temporaryCity" class="form-label fs-6">City <span class="text-danger fw-bold">*</span>:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryCity" name="temporaryCity" value="{{ old('temporaryCity', $bankAccount->temporaryCity ?? '') }}" required maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryTole" class="form-label fs-6">Tole <span class="text-danger fw-bold">*</span>:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryTole" name="temporaryTole" value="{{ old('temporaryTole', $bankAccount->temporaryTole ?? '') }}" required maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryStreet" class="form-label fs-6">Street:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryStreet" name="temporaryStreet" value="{{ old('temporaryStreet', $bankAccount->temporaryStreet ?? '') }}" maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryState" class="form-label fs-6">State:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryState" name="temporaryState" value="{{ old('temporaryState', $bankAccount->temporaryState ?? '') }}" maxlength="255">
                                </div>
                                <div class="col">
                                    <label for="temporaryHouseNo" class="form-label fs-6">House No:</label>
                                    <input type="text" class="form-control form-control-da fs-6" id="temporaryHouseNo" name="temporaryHouseNo" value="{{ old('temporaryHouseNo', $bankAccount->temporaryHouseNo ?? '') }}" maxlength="255">
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-da fs-6" id="jobTitle" name="jobTitle" value="{{ old('jobTitle', $bankAccount->jobTitle ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="jobCity" class="form-label fs-6">Job City:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="jobCity" name="jobCity" value="{{ old('jobCity', $bankAccount->jobCity ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="companyName" class="form-label fs-6">Company Name:</label>
                                        <input type="text" class="form-control form-control-da fs-6" id="companyName" name="companyName" value="{{ old('companyName', $bankAccount->companyName ?? '') }}" maxlength="255">
                                    </div>
                                    <div class="col">
                                        <label for="yearlySalary" class="form-label fs-6">Yearly Salary:</label>
                                        <input type="number" step="0.01" class="form-control form-control-da fs-6" id="yearlySalary" name="yearlySalary" value="{{ old('yearlySalary', $bankAccount->yearlySalary ?? '') }}">
                                    </div>
                                    <div class="col">
                                        <label for="monthlySalary" class="form-label fs-6">Monthly Salary:</label>
                                        <input type="number" step="0.01" class="form-control form-control-da fs-6" id="monthlySalary" name="monthlySalary" value="{{ old('monthlySalary', $bankAccount->monthlySalary ?? '') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-2 row-gap-3">
                                    ...
                                    <div class="col">
                                        <label for="signature" class="form-label fs-6">
                                            Signature Photo @if(!isset($bankAccount))<span class="text-danger fw-bold">*</span>@endif:
                                        </label>
                                        <br>
                                        ...
                                        <img src="{{ asset($bankAccount->signature) }}"
                                            alt="Signature Preview"
                                            class="img-fluid img mt-2 rounded"
                                    ...
                                    <div class="col">
                                        <label for="fingerPrint" class="form-label fs-6">
                                            Thumb Print Photo @if(!isset($bankAccount))<span class="text-danger fw-bold">*</span>@endif:
                                        </label>
                                        <br>
                                        <label class="form-label fs-6 mb-3">(Should be in .jpg, .jpeg, .png, .pdf format)</label>
                                        ...
                                        <img src="{{ asset($bankAccount->fingerPrint) }}"
                        ...
                        <div class="d-flex justify-content-end py-4">
                            <button type="submit" class="btn btn" style="background-color: #0064a7; color: white;">
