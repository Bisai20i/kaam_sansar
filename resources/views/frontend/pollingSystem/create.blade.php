...
<section class="prform">
    <div class="container-fluid container-lg">
        <div id="form-container" style="margin-bottom: 30px;">
            <div id="Pollsystem" class="multi-step-form">
                <div class="container">
                    <div class="">
                        <div class="border border-1 rounded-2 p-5 w-100" style="box-shadow: 2px 2px 12px 0px #00000014;">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('polls.store') }}" id="pollForm" style="margin-bottom: 10;">
                                    @csrf
                                    ...
                                    <div class="poll-options">
                                        ...
                                        <div class="d-flex align-items-center mb-2 poll-option" style="width: 100%;">
                                            ...
                                            <div class="bar-container" style="width: 82%; margin-top:-15px; position: relative; height: 40px; border-radius: 4px; background-color: #dee2e6; overflow: hidden;">
                                                @if($percentage > 0)
