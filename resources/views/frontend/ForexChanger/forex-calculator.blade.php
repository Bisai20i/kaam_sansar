        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="container d-flex justify-content-end">
                    <button class="bg-white border-0 border-bottom border-primary mt-2"><a href="{{ route('moneyExchanges.create') }}" class="text-decoration-none text-primary fw-semibold fs-6">Become a Money Exchanger<i class="bi bi-arrow-right ms-2"></i></a></button>
                </div>
                <div class="">
            ...
            <div class=" row d-inline-flex  bg-success-subtle border border-2 mb-3 border-success-subtle align-items-center py-4 rounded-2 px-3 mb-2" role="alert">
