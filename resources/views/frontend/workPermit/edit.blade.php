    ...
    <div class="my-3 mb-5 border container border-1 border-dark-subtle rounded-4 p-3 p-md-5">
        <form id="workPermitEditForm" action="{{ route('workPermits.update', $workPermit->id) }}" enctype="multipart/form-data" method="POST" class="accordion">
            ...
            <div id="firstForm">
                ...
                <div class="mt-5">
                    <h4 style="color:#0064a7;">Instructions</h4>
                    <p class="fs-6 my-3">Please review the instructions before updating your application</p>
                    <p class="fs-6 text-black-50">Read before pre-enrollment
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore libero repellendus quo.
                        Consectetur vel placeat sit temporibus ab ex explicabo, dicta officia, pariatur aspernatur, eos expedita.
                        Enim officiis eaque vel esse ab eos, debitis nesciunt accusantium in ea voluptate ipsa. Laboriosam vero repudiandae
                        magnam eum expedita? Expedita ab corrupti minus voluptates aspernatur laboriosam libero iure illum? Totam debitis
                        dicta voluptas voluptatem esse iste beatae incidunt officia consequatur. Natus omnis excepturi praesentium, aliquid
                        officia, a porro aspernatur officiis ullam quasi sapiente debitis quidem eligendi sequi distinctio esse laboriosam illo dignissimos nostrum minima dolorum eos. Accusamus est, sequi sapiente at sunt ut. Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro excepturi iusto, placeat deleniti, molestias repudiandae sed officiis dolorum optio illo rem iure voluptate nisi nostrum libero consequatur. A molestias blanditiis dignissimos voluptates neque provident possimus non alias consequatur. Facilis vitae soluta, debitis ex incidunt dicta eos officiis blanditiis rerum non iste quod dolores atque cupiditate. Nam incidunt porro saepe debitis quibusdam laboriosam vero maiores enim labore eveniet aliquid inventore officiis libero ullam sit sapiente illum adipisci dicta, qui blanditiis? Voluptate minima vel qui quisquam, cupiditate consequatur ratione
                        voluptatem minus numquam quos! Rem atque, quidem ipsam corporis deserunt veniam possimus facilis.</p>
                </div>
                <div class="mt-5">
            ...
            <div id="mainForm" class="d-none">
                ...
                <div class="row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3 gx-3">
                    <div class="col">
                        <label for="contCountry" class="form-label fs-6">Country</label>
                        <input type="text" class="form-control" id="contCountry" name="contCountry" value="{{ old('contCountry', $workPermit->contCountry) }}">
                    </div>

                    <div class="col">
                        <label for="state" class="form-label fs-6">State</label>
                        <input type="text" class="form-control" id="state" name="state" value="{{ old('state', $workPermit->state) }}">
                    </div>

                    <div class="col">
                        <label for="contdistrict" class="form-label fs-6">District</label>
                        <input type="text" class="form-control" id="contdistrict" name="contdistrict" value="{{ old('contdistrict', $workPermit->contdistrict) }}">
                    </div>

                    <div class="col">
                        <label for="contCity" class="form-label fs-6">City</label>
                        <input type="text" class="form-control" id="contCity" name="contCity" value="{{ old('contCity', $workPermit->contCity) }}">
                    </div>

                    <div class="col">
                        <label for="phoneNo" class="form-label fs-6">Phone Number</label>
                        <input type="tel" class="form-control" id="phoneNo" name="phoneNo" value="{{ old('phoneNo', $workPermit->phoneNo) }}">
                    </div>

                    <div class="col">
                        <label for="email" class="form-label fs-6">Email Address</label>
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $workPermit->email) }}">
                    </div>
                </div>
                ...
                <div class="row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3 gx-3">
                    ...
                    <div class="col">
                        <label for="emergencyContactEmail" class="form-label fs-6">Emergency Contact Email</label>
                        <input type="text" class="form-control" id="emergencyContactEmail" name="emergencyContactEmail" value="{{ old('emergencyContactEmail', $workPermit->emergencyContactEmail) }}">
                    </div>

                    <div class="col">
                        <label for="emergencyContactPhone" class="form-label fs-6">Emergency Contact Phone</label>
                        <input type="text" class="form-control" id="emergencyContactPhone" name="emergencyContactPhone" value="{{ old('emergencyContactPhone', $workPermit->emergencyContactPhone) }}">
                    </div>
                </div>
                <h4 class="d-inline py-2 accordion-header fs-5 text-semibold" style="color:#0064a7;">
                    Required Documents
                ...
                <div class="row py-3 row-cols-1 row-cols-md-2 row-cols-lg-3 row-gap-3 gx-3">
                    <!-- Existing fields -->
                    <div class="col">
                        <label for="citizenshipFront" class="form-label fs-6">Citizenship Front:</label>
                        <br>
                        <input type="file" class="form-control" id="citizenshipFront" name="citizenshipFront" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->citizenshipFront)
                        <div class="existing-file">
                            <span>Current file:</span>
                            <img src="{{ asset($workPermit->citizenshipFront) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>

                    <!-- ... citizenshipBack, previousPassport, otherDocument inputs ... -->

                    <!-- New fields -->

                    <div class="col">
                        <label for="passportPhoto" class="form-label fs-6">Passport Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="passportPhoto" name="passportPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->passportPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->passportPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="bankAccountPhoto" class="form-label fs-6">Bank Account Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="bankAccountPhoto" name="bankAccountPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->bankAccountPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->bankAccountPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="visaPhoto" class="form-label fs-6">Visa Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="visaPhoto" name="visaPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->visaPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->visaPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="chequePhoto" class="form-label fs-6">Cheque Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="chequePhoto" name="chequePhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->chequePhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->chequePhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="agreementPhoto" class="form-label fs-6">Agreement Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="agreementPhoto" name="agreementPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->agreementPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->agreementPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="arrivalStampPhoto" class="form-label fs-6">Arrival Stamp Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="arrivalStampPhoto" name="arrivalStampPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->arrivalStampPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->arrivalStampPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="embassyLetterPhoto" class="form-label fs-6">Embassy Letter Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="embassyLetterPhoto" name="embassyLetterPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->embassyLetterPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->embassyLetterPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="departureStampPhoto" class="form-label fs-6">Departure Stamp Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="departureStampPhoto" name="departureStampPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->departureStampPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->departureStampPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="oldLaborApprovalPhoto" class="form-label fs-6">Old Labor Approval Photo:</label>
                        <br>
                        <input type="file" class="form-control" id="oldLaborApprovalPhoto" name="oldLaborApprovalPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->oldLaborApprovalPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->oldLaborApprovalPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                    ...
                    <div class="col">
                        <label for="otherDocumentsPhoto" class="form-label fs-6">Other Supporting Documents:</label>
                        <br>
                        <input type="file" class="form-control" id="otherDocumentsPhoto" name="otherDocumentsPhoto" accept=".jpg,.jpeg,.png,.pdf" onchange="handleImagePreview(this)">
                        @if($workPermit->otherDocumentsPhoto)
                        <div class="existing-file">
                            <img src="{{ asset($workPermit->otherDocumentsPhoto) }}" target="_blank" class="img-fluid my-2">
                        </div>
                        @endif
                        <img src="#" alt="preview Image" class="img img-fluid my-2 d-none">
                    </div>
                ...
                <div class="d-flex flex-column mx-3 mb-5">
                    <div class="form-check">
                        <input class="form-check-input fs-5" type="checkbox" value="" id="checkCorrect" required>
                    ...
                    <div class="form-check">
                        <input class="form-check-input fs-5" type="checkbox" value="" id="checkTerms" required>
