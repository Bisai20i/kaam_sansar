    ...
    <div class="card p-4">
        <form id="profilesForm" enctype="multipart/form-data">
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <!-- Upload Button -->
                <label for="profileUpload" class="btn btn-primary border-0 bg-transparent" style="color:#0064A7;">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control custom-input" name="firstName" id="firstname"
                        value="{{ $profile->firstName ?? (Auth::guard('job_seekers')->user()->firstName ?? '') }}"
                        placeholder="Enter your First Name" required>
                </div>
                <div class="col-md-6">
                    <label for="last-name" class="form-label">Last Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control custom-input" name="lastName" id="last-name"
                        value="{{ $profile->lastName ?? (Auth::guard('job_seekers')->user()->lastName ?? '') }}"
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control custom-input" name="designation" id="designation"
                        value="{{ $profile->designation ?? (Auth::guard('job_seekers')->user()->designation ?? '') }}"
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control custom-input" name="address" id="address"
                        value="{{ $profile->address ?? (Auth::guard('job_seekers')->user()->address ?? '') }}"
                        placeholder="Enter your Address" required>
                </div>
                <div class="col-md-6">
                    <label for="country" class="form-label">Country <span class="text-danger">*</span></label>
                    <input type="text" class="form-control custom-input" name="country" id="country"
                        value="{{ $profile->country ?? (Auth::guard('job_seekers')->user()->country ?? '') }}"
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control custom-input" name="email" id="email"
                        value="{{ $profile->email ?? (Auth::guard('job_seekers')->user()->email ?? '') }}"
                        placeholder="Enter your Email" required />
                </div>
                <div class="col-md-6">
                    <label for="phone" class="form-label">Phone <span class="text-danger">*</span></label>
                    <input type="text" class="form-control custom-input" name="phoneNumber" id="phone"
                        value="{{ $profile->phoneNumber ?? (Auth::guard('job_seekers')->user()->phoneNumber ?? '') }}"
            ...
            <div class="text-end">
                <button type="button" class="btn text-center skip-btn mx-2 float-end border-primary text-primary"
                    id="saveProfile" data-current="profile" data-next="visa" data-link="visaLink">
                    Save and Continue
                </button>
            </div>
        </form>
