        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav gap-3 m-auto mb-2 mb-lg-0">
                ...
                @if (Auth::guard('job_seekers')->check())
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('polls*') || request()->routeIs('quiz*') ? 'active-navLink' : '' }}"
                            href="#" id="gamesDropdown" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            Games
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="gamesDropdown">
                            <li><a class="dropdown-item {{ request()->routeIs('quiz*') ? 'active-dropdown-item' : '' }}"
                                    href="{{ route('quiz.frontend') }}">Quiz</a></li>
                            <li><a class="dropdown-item {{ request()->routeIs('polls*') ? 'active-dropdown-item' : '' }}"
                                    href="{{ route('polls.create') }}">Exist Poll</a></li>
            ...
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <h5 class="card-title">{{ @Auth::guard('job_seekers')->user()->firstName }}
                        ...
                        <a href="{{ route('jobseeker.editProfile', ['user_id' => @Auth::guard('job_seekers')->user()->id]) }}"
                            class="d-block">
                ...
                <ul class="list-unstyled text-start">
                    ...
                    <li><a href="{{ route('jobseeker.resume-maker') }}" class="d-block text-decoration-none"><i
                                class="fas fa-edit p-1 text-decoration-none"></i>
                            Edit CV</a></li>
                    <hr>
                    <li><a href="#" class="d-block text-decoration-none"><i
                                class="fas fa-share-alt p-1 text-decoration-none"></i>
                            Share</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-4">
            ...
            <div class="modal-body p-0 icon-gray" style="font-family: unset;">
                ...
                <form class="d-flex gap-2 justify-content-center" id="social-login"
                    action="{{ route('auth.google') }}">

                    <button type="submit"
                        class="btn-outline-secondary w-100 d-flex align-items-center justify-content-center">
                ...
                <form action="{{ route('auth.google') }}" class="d-flex gap-2 justify-content-center">
                    <button type="submit"
                        ...
                        <img class="img-fluid shadow-sm"
                            src="{{ asset('frontend/assets/Images/icons8-google-48.png') }}" alt="Google Logo">
                        Google
                    </button>
