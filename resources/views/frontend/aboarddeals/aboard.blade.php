                        ...
                        <form id="newPostForm" action="{{ route('aboards.store') }}" method="POST"
                            ...
                            <div class="image-upload-block" data-id="post1">
                                <div class="mb-3 input-group">
                                    ...
                                    <input type="file" name="productThumbnail" class="d-none image-input"
                                        accept="image/*" />
                                </div>

                                <div class="mb-3 image-preview-container" style="display: none;">
                                    <img class="img-fluid image-preview" alt="Selected Image"
                                        style="width: 120px; height: 80px;" />
                                </div>
                            </div>
            ...
            <div class="container mt-2">
                <div class="row">
                    ...
                    <div class="col-md-9">
                                ...
                                <div class="card-body">
                                    ...
                                    @if (!empty($ad->productThumbnail))
                                        <div class="mt-2 w-100"
                                            style="overflow: hidden; border-radius: 8px; height: 200px;">
                                    ...
                                    <div class="d-flex gap-4 ms-2">
                                        ...
                                        <button type="button" class="btn text-primary" data-bs-toggle="modal"
                                            data-bs-target="#commentModal" onclick="loadComments({{ $ad->id }})">
                                                            ...
                                                            @foreach ($comments as $cmt)
                                                                <div class="d-flex align-items-start mb-3">
                                                                    ...
                                                                    <div class="flex-grow-1">
                                                                        <div class="bg-light border rounded-3 px-3 py-2">
                                                                            <h6 class="fw-semibold mb-1">
                                                                                {{ $cmt->jobSeeker->firstName }}
                                                                                {{ $cmt->jobSeeker->lastName }}</h6>
                                                                            <p class="mb-1">{{ $cmt->comment }}</p>
                                                                        </div>
                                                                        <small
                                                                            class="text-muted">{{ $cmt->created_at->diffForHumans() }}</small>
                                                                    </div>
                                                                    ...
                                                                    @if (Auth::guard('job_seekers')->check() && Auth::guard('job_seekers')->user()->id === $cmt->jobSeekerId)
                                                                        <button class="btn ms-2" data-bs-toggle="modal"
                        ...
                        @foreach ($ads as $ad)
                            <img src="{{ $ad->jobSeeker->userThumbnail ? asset('storage/' . $ad->jobSeeker->userThumbnail[0]) : '' }}"
                                 class="rounded-circle me-2"
