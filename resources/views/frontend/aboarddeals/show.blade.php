            ...
            <div class="container mt">
                <div class="row mt">
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-3 border border-1 rounded p-2 fixed-height">
                        ...
                        <!-- Responsive Image -->
                        <img src="{{ $aboard->productThumbnail ? asset($aboard->productThumbnail) : asset('frontend/assets/Images/teddy-bear.jpg') }}"
                            class="bdy-packages-img mb-2" alt="Product Image"
                        ...
                        <div class="profile-price d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <img src="{{ $aboard->jobSeeker->userThumbnail ? asset('storage/' . $aboard->jobSeeker->userThumbnail[0]) : asset('frontend/assets/Images/profile.jpg') }}"
                                    class="rounded-circle abroad-chat" alt="Profile picture of Ram Baral">
                                <div class="ms-2">
                                    <p class="fw-semibold mb-0">{{ $aboard->jobSeeker->firstName }}
                                        {{ $aboard->jobSeeker->lastName }}</p>
                    ...
                    <div class="col-md-9 ps-md-4 mt-3 mt-md-0 border-0 fixed-height">
                        ...
                        <div class="step-container-gifts gap-4">
                            ...
                            <button class="btn step-button-gifts active1" onclick="setActive(0)">
                            ...
                            <nav>
                                <ul class="pagination justify-content-end converter">
                                    ...
                                    @if ($currentPage > $pageRange + 1)
                                        <li class="page-item">
                                            <a class="page-link primary_color_text"
                                                href="{{ $similarProducts->url(1) }}">1</a>
                                        </li>
