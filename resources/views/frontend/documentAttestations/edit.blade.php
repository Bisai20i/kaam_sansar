            ...
            <form id="form" method="POST" action="{{ route('documentAttestations.update', $attestation->id) }}" enctype="multipart/form-data">
                ...
                <div id="multiStepForm1" class="multi-step-form" style="display:block;">
                    ...
                    <div class="mt-5 border border-1 border-dark-subtle rounded-4 p-3 p-md-5">
                        ...
                        <div class="mb-3">
                            <label for="documentType" class="form-label">Select Type <span class="text-danger fw-bold">*</span></label>
                            <select id="documentType" name="documentType" class="form-select w-50" aria-label="Default select example" required>
                                <option value="Nagrita" {{ $attestation->documentType == 'Nagrita' ? 'selected' : '' }}>Nagrita</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="subType" class="form-label">Select Sub-type <span class="text-danger fw-bold">*</span></label>
                            <select id="subType" name="subType" class="form-select w-50" aria-label="Default select example" required>
                                <option value="Photocopy" {{ $attestation->subType == 'Photocopy' ? 'selected' : '' }}>Photocopy</option>
                            </select>
                        </div>
                        <div class="mt-5">
                        ...
                        <div>
                            <div class="row row-cols-1">
                                <div class="col">
                                    ...
                                    <input type="text" id="applicantCountry" name="applicantCountry" class="form-control my-2 w-50" placeholder="Enter your country" required value="{{ $attestation->applicantCountry }}">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" id="attestationCountry" name="attestationCountry" class="form-control w-50 my-2" placeholder="Enter country name" required value="{{ $attestation->attestationCountry }}">
                            ...
                            <div class="accordion-body row py-3 row-cols-1 row-cols-md-2 row-cols-lg-2 row-gap-3">
                                ...
                                <div class="col">
                                    ...
                                    <select class="form-select text-muted fs-6" id="purpose" name="purpose" required>
                                        ...
                                        <option value="something" {{ $attestation->purpose == 'something' ? 'selected' : '' }}>Something</option>
                                    </select>
                                </div>
                            </div>
                        </div>
