...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="content-wrapper">
            <h4 class="fw-bold mb-4"><span class="text-muted fw-light"> </span> Edit Reward</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('rewards.update', $reward->id) }}" id="RewardForm">
                                @csrf
                                @method('PUT') <!-- Since this is an update, we need to specify PUT method -->
                                <div class="row">
                                    <!-- Job Seeker -->
                                        ...
                                        <select class="form-control {{ $errors->has('job_seekers_id') ? 'is-invalid' : '' }}" 
                                            ...
                                            @foreach($jobSeekers as $jobSeeker)
                                                <option value="{{ $jobSeeker->id }}" 
                                                    {{ old('job_seekers_id', $reward->job_seekers_id) == $jobSeeker->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="number" class="form-control {{ $errors->has('reward_points') ? 'is-invalid' : '' }}"
                                               id="reward_points" name="reward_points" value="{{ old('reward_points', $reward->reward_points) }}" 
