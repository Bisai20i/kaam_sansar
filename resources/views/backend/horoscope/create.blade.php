...
@section('content')
    <div class="container py-4">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <form id="formAuthentication" class="mb-3" novalidate method="POST"
                    action="{{ isset($horoscope) ? route('horoscope.update', $horoscope->id) : route('horoscope.store') }}"
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <label for="zodiacSignEnglish" class="form-label">Zodiac Sign [English] <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('zodiacSignEnglish') is-invalid @enderror"
                                id="zodiacSignEnglish" name="zodiacSignEnglish"
                                value="{{ old('zodiacSignEnglish', $horoscope->zodiacSignEnglish ?? '') }}"
                                placeholder="Enter here zodiac sign name in English" required>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <label for="zodiacSignNepali" class="form-label">Zodiac Sign [Nepali] <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('zodiacSignNepali') is-invalid @enderror"
                                id="zodiacSignNepali" name="zodiacSignNepali"
                                value="{{ old('zodiacSignNepali', $horoscope->zodiacSignNepali ?? '') }}"
                                placeholder="Enter here zodiac sign name in Nepali" required>
                            @error('zodiacSignNepali')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="birthMonth" class="form-label">Birth Month <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type"
                                required>
                                <option value="daily"
                                    {{ old('type', $horoscope->type ?? '') == 'daily' ? 'selected' : '' }}>Daily</option>
                                <option value="weekly"
                                    {{ old('type', $horoscope->type ?? '') == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                <option value="monthly"
                                    {{ old('type', $horoscope->type ?? '') == 'monthly' ? 'selected' : '' }}>Monthly
                                </option>
                                <option value="yearly"
                                    {{ old('type', $horoscope->type ?? '') == 'yearly' ? 'selected' : '' }}>Yearly</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <label for="contentEn" class="form-label">Zodiac Sign Content (English) <span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control @error('contentEn') is-invalid @enderror" id="contentEn" name="contentEn" rows="4"
                                placeholder="Enter here zodiac sign description in English" required>{{ old('contentEn', $horoscope->contentEn ?? '') }}</textarea>
                            @error('contentEn')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="contentNp" class="form-label">Zodaic Sign Content (Nepali) <span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control @error('contentNp') is-invalid @enderror" id="contentNp" name="contentNp" rows="4"
                                placeholder="Enter here zodiac sign description in Nepali">{{ old('contentNp', $horoscope->contentNp ?? '') }}</textarea>
                            @error('contentNp')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            document.addEventListener("DOMContentLoaded", function() {
                                ...
                                function updatePublishDate() {
                                    ...
                                    if (selectedType === "daily") {
                                        ...
                                        let monthEnStart = startDate.toLocaleString('default', {
                                            month: 'long'
                                        });
                                        let monthEnEnd = endDate.toLocaleString('default', {
                                            month: 'long'
                                        });
                                        ...
                                        let monthEn = today.toLocaleString('default', {
                                            month: 'long'
                                        });
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="nameStartLetter" class="form-label">Name Start Letter <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('nameStartLetter') is-invalid @enderror"
                                id="nameStartLetter" name="nameStartLetter"
                                value="{{ old('nameStartLetter', $horoscope->nameStartLetter ?? '') }}"
                                placeholder='Enter here astro letter like "चु", "चे", "चो", "ला", "लि", "लु", "ले", "लो"'
                                required>
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="zodiacImgNepali" class="form-label">Nepali Rashifal Image<span
                                    class="text-danger">*</span></label>
                            <input type="file" class="form-control @error('zodiacImgNepali') is-invalid @enderror"
                                id="fileNepali" name="zodiacImgNepali" accept="image/*"
                                onchange="previewImage(event, 'imagePreviewNepali')">
                            ...
                            <div class="mt-3">
                                <img id="imagePreviewNepali"
                                    src="{{ isset($horoscope) && $horoscope->zodiacImgNepali ? asset($horoscope->zodiacImgNepali) : '' }}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="file" class="form-control @error('zodiacImgEnglish') is-invalid @enderror"
                                id="fileEnglish" name="zodiacImgEnglish" accept="image/*"
                            ...
                            <div class="mt-3">
                                <img id="imagePreviewEnglish"
                                    src="{{ isset($horoscope) && $horoscope->zodiacImgEnglish ? asset($horoscope->zodiacImgEnglish) : '' }}"
                                    alt="Selected Zodiac Image"
