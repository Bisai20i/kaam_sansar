        ...
        <div class="content-wrapper">
                    ...
                    <div class="col-12 ">
                        <div class="card mb-4">
                            <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                                <form class="input-group" style="flex: 1 1 300px;" action="{{ route('forum.index') }}"
                                    method="get">
                                    <input type="text" class="form-control" id="subTask" name="searchstr"
                                        value="{{ request('searchstr') }}" placeholder="Search by User or Post"
                                        style="flex: 1;">
                                ...
                                <div class="d-flex ps-0 ps-md-2 align-items-center gap-2 justify-content-center justify-content-lg-end flex-wrap"
                                                ...
                                                @if ($forums->count() > 0)
                                                    ...
                                                    @foreach ($forums as $forum)
                                                        <tr>
                                                            ...
                                                            <td
                                                                class="d-flex row-cols-2 justify-content-center gap-1 flex-wrap">
                                                                @if ($forum->images)
                                                                    @foreach ($forum->images as $image)
                                                                        <img src="{{ asset('storage/' . $image) }}"
                                                                            alt="forum"
                                                                            class="img img-thumbnai img-fluid"
            ...
            <script>
                ...
                function setPinUnpinRoute(id) {
                    ...
                    document.getElementById('pinModalActionButton').href = "{{ route('discussion.pinpost', ':id') }}".replace(
                        ':id',
                        id);
