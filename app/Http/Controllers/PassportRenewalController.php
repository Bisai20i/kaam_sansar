...
class PassportRenewalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        PassportRenewal::create($validatedData);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
            // Validation rules as in store method
        ]);
        ...
        return redirect()->route('frontend.passport-renewal.index.edit', $id)->with('success', 'Passport renewal application updated successfully!');
    }
}