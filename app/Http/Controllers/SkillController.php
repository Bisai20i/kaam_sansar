...
class SkillController extends Controller
{
    ...
    public function storeskill(Request $request)
    {
        ...
        Log::info('new Skill record created:'.$skill->id);
        $skill->save();
        Log::info('Skill created successfully:'. $skill);

        //return the response based on request type
         return $isMobile
         ? $this->responseSuccess('Skill created successfully.', 201, $skill)
         :redirect()->back()->with('success','Skill created successfully.');
